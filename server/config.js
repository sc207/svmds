...
const config = {
  ...
  /* Signed out after this long without a single request, however much of
     the 7 days is left — a counter laptop left signed in overnight. */
  sessionIdleHours: parseInt(process.env.SESSION_IDLE_HOURS || '12', 10),
